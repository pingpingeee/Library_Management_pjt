<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
   <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      ...
      <head>
         ...
         <link rel="stylesheet" type="text/css" href="/pilotpjt/resources/css/user_update.css">
         ...
         <h2>회원 정보 수정</h2>
            ...
            <div>
               <label for="userName">이름</label> <input type="text" id="userName" name="userName"
                  value="${loginUser.userName}" required readonly/>
            </div>
            ...
            <div class="form-group">
               ...
               <input type="tel" name="userTel" required value="${loginUser.userTel}" placeholder="010-0000-0000"
                  pattern="^010-\d{4}-\d{4}$"
            ...
            <div class="form-group full-width">
               ...
               <input type="text" name="userDetailAddress" placeholder="상세 주소 입력 (선택사항)"
                  value="${loginUser.userDetailAddress}">
               <span class="input-hint">아파트, 동/호수 등 상세 주소를 입력해주세요.</span>
            </div>


            <div>
               <label for="userPassword">새 비밀번호</label> <input type="password" id="userPassword"
                  name="userPassword" placeholder="비밀번호를 변경하려면 입력하세요" />
            </div>
